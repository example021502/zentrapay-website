...
export default function Home() {
  ...
  useEffect(() => {
    ...
    getHome()
      .then((data) => {
        ...
        setDeviceFeatures(data.deviceFeatures || []);
  ...
  const handleDownloading = (platform) => {
    const playStoreUrl =
      ...
      >
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          >
            <img
              src={
                "https://i.ibb.co/hF104cxC/509fa0f22f3b93debf689037eb1e7244.jpg" ??
                imgPlaceholder
              }
              alt="Device showcase"
      ...
      >
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          >
            <img
              src={
                "https://i.ibb.co/nqVM6pXZ/a4df22d5df3a19ea8a65655462b1c1dc.jpg" ??
                imgPlaceholder
              }
              alt="Phone mockups"
